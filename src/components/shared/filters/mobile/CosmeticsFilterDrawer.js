// src/components/shared/filters/mobile/CosmeticsFilterDrawer.js
        ...
        <div className="drawer-body">
          ...
          <div className="filter-section">
            ...
            >
              ...
              {COSMETICS_PRODUCT_TYPES.map((option) => (
          ...
          <div className="filter-section">
            ...
            >
              <option value="">Hamısı</option>
              {COSMETICS_CATEGORIES.map((option) => (
                <option key={option.value} value={option.value}>
                  {option.label}
                </option>
              ))}
          ...
          <div className="filter-section">
            ...
            <div className="radio-group">
              {COSMETICS_CONDITIONS.map((option) => (
...
export default CosmeticsFilterDrawer;
