                ...
                <div class="col-lg-9 col-md-10 mx-auto">
                  <div class="jumbotron__inner">
                    <div class="jumbotron__info">
                      ...
                      <p class="mb-30">
                        Ayda əlavə 3000 satış realdır, sadəcə bizə qoşulmaq
                        kifayətdir!
                      </p>
                      <Link href="/store/register" class="btn btn--white">
                        Mağaza qeydiyyatı
                      </Link>
                    </div>
                ...
                <div class="advantage">
                  <div class="advantage__item">
                    ...
                    <p class="advantage__title">
                      İlk həftə pulsuz! Sonra hər ay cəmi 10 AZN
                    </p>
                    <p>
                  ...
                  <div class="advantage__item">
                    ...
                    <p class="advantage__title">
                      90 gün aktiv olan mağaza elanları
                    </p>
                    <p>
                      Aecenas tempus, tellus eget condimentum rhoncus, sem quam
                  ...
                  <div class="advantage__item">
                    ...
                    <p class="advantage__title">
                      Bütün elanların incə idarəetməsi
                    </p>
                    <p>
                      Zucenas tempus, tellus eget condimentum, sem quam semper
                      libero.
                    </p>
                  </div>
                </div>
                ...
                <div class="col-lg-9 col-md-10 mx-auto">
                  <div class="jumbotron__inner">
                    <div class="jumbotron__info jumbotron__info--secondary">
                      ...
                      <Link href="/store/register" class="btn">
                        Mağaza qeydiyyatı
                      </Link>
                    </div>
                    <div class="jumbotron__img">
