                  ...
                  <div class="pb-15">
                        ...
                        <div class="file__rapper">
                          ...
                          <div class="d-md-flex">
                            ...
                            <div class="pt-10 pl-md-4 mb-20 mb-lg-0">
                              <a
                                href=""
                                class="btn btn--action btn--small btn--edit mb-10"
                              >
                                Dəyiş
                              </a>
                              <a
                                href=""
                                class="btn btn--action btn--small btn--delete mb-10"
                              >
                                Elanı sil
                              </a>
                            </div>
                          </div>
                          <span class="file__info text-left">
                            Yalnız 1 şəkil, ağ fon üzərində. Optimal ölçü:
                            500×500px.
                          </span>
                        </div>
                      </div>
                    ...
                    <div class="form-group">
                      ...
                      <div class="textarea-group">
                        <textarea
                          ...
                          maxlength="3000"
                        >
                          Çox babat telefondu. arada bir dinamiki xarab olur
                          dişimlə sıxıram telefonu düzəlir.
                        </textarea>
                    ...
                    <div class="form-group">
                      ...
                      <input
                        ...
                        id="address"
                        class="form-control"
                        value="Nizami ray., Aşıq Mollacümə küç. 19/21"
                      />
                    </div>
                    <div class="form-group">
                      ...
                      <input
                        ...
                        id="map-link"
                        class="form-control"
                        value="https://www.google.com/maps/place/WorldTelecom/@40.3741508,49.8416086,17z/data=!3m1!4b1!4m5!3m4!1s0x40307da5c0713051:0x70a5ea1f211fdb5a!8m2!3d40.3741464!4d49.8437964"
                      />
                    </div>
                      ...
                      <div class="input-group">
                        ...
                        <div class="input-group-append">
                          <button class="input-group-btn">
                            <img src="/img/delete_gray-icon.svg" alt="" />
                          </button>
                        </div>
                      </div>
                      <div class="input-group">
